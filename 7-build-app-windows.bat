...
call reportgenerator "-title:Hotels Library Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_lib_win.info" "-targetdir:docs/coverxygenlibwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_win"
...
call reportgenerator "-title:Hotels Library Test Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_test_win.info" "-targetdir:docs/coverxygentestwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_win"
...
echo Generate Test Coverage Data for Hotels
call OpenCppCoverage.exe --export_type=binary:hotels_tests_unit_win.cov --sources src\hotels\src --sources src\hotels\header --sources src\tests\hotels -- build_win\build\Debug\hotels_tests.exe

echo Generate Test Coverage Data for Hotels App and Combine Results
call OpenCppCoverage.exe --input_coverage=utility_tests_unit_win.cov --input_coverage=hotels_tests_unit_win.cov --export_type=cobertura:hotelsapp_unit_win_cobertura.xml --sources src\utility\src --sources src\utility\header --sources src\hotels\src --sources src\hotels\header --sources src\hotelsapp\src --sources src\hotelsapp\header --sources src\tests\utility --sources src\tests\hotels -- build_win\build\Debug\hotelsapp.exe

echo Generate Unit Test Coverage Report
call reportgenerator "-title:Hotels Library Unit Test Coverage Report (Windows)" "-targetdir:docs/coveragereportlibwin" "-reporttypes:Html" "-reports:**/hotelsapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/hotels/src;src/hotels/header;src/hotelsapp/src;src/hotelsapp/header;src/tests/utility;src/tests/hotels" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_win"
call reportgenerator "-targetdir:assets/codecoveragelibwin" "-reporttypes:Badges" "-reports:**/hotelsapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/hotels/src;src/hotels/header;src/hotelsapp/src;src/hotelsapp/header;src/tests/utility;src/tests/hotels" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
...
call robocopy src\hotels\header "build_win\build\Release" /E
call robocopy src\hotelsapp\header "build_win\build\Release" /E
...
call robocopy src\hotels\header "build_win\build\Debug" /E
call robocopy src\hotelsapp\header "build_win\build\Debug" /E
